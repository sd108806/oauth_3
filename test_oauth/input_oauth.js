...
*/
	...
	var result="oauth_token_secret=6X9Bmz3DKBBe9zMTAaDPZ45zdZYjndHz&oauth_token=U69XAwM8pf8mXppL4s&oauth_callback_confirmed=true" ;
			
			var n1=result.indexOf('&',0);  // find the location of the first '&'
			document.write('n1 '+n1+'  ' );
			var request_oauth_token_secrete=result.substring(0,n1);   // get oauth token secrete
			document.write('request_oauth_token_secrete '+ request_oauth_token_secrete +'  ');
			
			var n2=result.indexOf('&',n1+1);   // find the location of the second '&'
			document.write('n2 '+n2 +'  ');
			var request_oauth_token=result.substring(n1+1,n2);   // get oauth token secrete
